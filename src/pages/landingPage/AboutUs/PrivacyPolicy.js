  ...
  return (
    <div className="bg-light text-xl">
      <div className="md:py-44 py-16 max-w-4xl mx-auto px-3 text-left">
        ...
        <p>
          CraftConnect is responsible for the personal information about you that
        ...
        <p>
          ...
          <span className="font-bold">Nikunjay(Chaudhary)</span> by email at{" "}
          <span className="font-bold">chaudharynikunjay@gmail.com</span>
        </p>
      </div>
    </div>
  );
